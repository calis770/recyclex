...
<head>
    ...
    <title>Tambah Seller Baru</title>
    ...
    <div class="container my-4">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title">Tambah Seller Baru</h3>
                ...
                <form action="{{ route('sellers.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('username_seller') is-invalid @enderror" 
                                       id="username_seller" name="username_seller" value="{{ old('username_seller') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('seller_phone_number') is-invalid @enderror" 
                                       id="seller_phone_number" name="seller_phone_number" value="{{ old('seller_phone_number') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('business_type') is-invalid @enderror" 
                                    ...
                                    <option value="Micro Enterprise" {{ old('business_type') == 'Micro Enterprise' ? 'selected' : '' }}>Micro Enterprise</option>
                                    <option value="Small Enterprise" {{ old('business_type') == '\Small Enterprise' ? 'selected' : '' }}>Small Enterprise</option>
                                    <option value="Medium Enterprise" {{ old('business_type') == 'Medium Enterprise' ? 'selected' : '' }}>Medium Enterprise</option>
                                </select>
                                @error('business_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('seller_address') is-invalid @enderror" 
                                  id="seller_address" name="seller_address" rows="3" required>{{ old('seller_address') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('shop_description') is-invalid @enderror" 
                                  ...
                                  placeholder="Deskripsikan toko Anda...">{{ old('shop_description') }}</textarea>
